...
public class JuryRegistrationDialog extends JDialog {
    ...
    public static void open(Frame owner, AppContext context) {
        JuryRegistrationDialog dialog = new JuryRegistrationDialog(owner, context);
        dialog.setVisible(true);
    }

    private JuryRegistrationDialog(Frame owner, AppContext context) {
        super(owner, "Регистрация жюри", true);
    ...
    private void initUi() {
        ...
        idField.setText(context.registrationService().generateId("JURY"));
        ...
        saveButton.addActionListener(e -> saveJury());
    ...
    private void saveJury() {
        ...
        JuryMember member = context.registrationService().registerJury(idField.getText(),
        ...
        JOptionPane.showMessageDialog(this, "Жюри зарегистрирован: " + member.getIdNumber(), "Готово", JOptionPane.INFORMATION_MESSAGE);
        dispose();
    }
}
